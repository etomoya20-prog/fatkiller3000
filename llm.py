...
3. Данных о еде нет вовсе (вопрос, приветствие, случайная картинка) —
    ...
    return await _ask([
        {
            "type": "text",
            "text": (
                "Скриншот приложения учёта калорий. Внимательно посмотри на подписи "
                "у чисел: крупная цифра обычно означает остаток до нормы, а не съеденное."
            ),
        },
        {
            "type": "image_url",
